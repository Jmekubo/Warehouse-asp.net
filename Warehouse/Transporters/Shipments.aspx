<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shipments.aspx.cs" Inherits="Warehouse.Transporters.Shipments1" %>
...
<body>
    ...
    <div>
        ...
        <dx:ASPxDocumentViewer ID="ASPxDocumentViewer1" runat="server" 
            ReportTypeName="Warehouse.Transporters.Shipments">
